...
xhrTime.open("GET", "http://localhost:8080/getServerTime/"+TodayTripId, true);
...
function tripInprogress() {
	...
	xhr.open("GET", "http://localhost:8080/bookings/status/"+TodayTripId , true);
...
//alert(id);
	...
	xhrReached.open("PUT", "http://localhost:8080/employee/status/"+empId, true);
...
let ab = Number(TodayTripId);
	...
	xhrupdate.open("PUT", "http://localhost:8080/updateme/"+ab,true);
